use super::negmax::{self, CellValue};
    ...
    loop {
        ...
        match input_to_index(prompt, &board) {
            Some(index) => {
                ...
                negmax::print_board(&board);
                if negmax::is_player_win(&board, CellValue::Player) {
                ...
                println!("考え中....");
                let enemy_move = negmax::best_move(&board);
                ...
                negmax::print_board(&board);
                if negmax::is_player_win(&board, CellValue::Enemy) {
